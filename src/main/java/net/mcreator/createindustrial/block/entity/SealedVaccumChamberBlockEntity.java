...
public class SealedVaccumChamberBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(5, ItemStack.EMPTY);

	public SealedVaccumChamberBlockEntity(BlockPos position, BlockState state) {
		super(CreateIndustrialModBlockEntities.SEALED_VACCUM_CHAMBER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("sealed_vaccum_chamber");
	}
