...
public class PurestOfPureMoltenSiliconBlock extends LiquidBlock {
	public PurestOfPureMoltenSiliconBlock() {
		super(CreateIndustrialModFluids.PUREST_OF_PURE_MOLTEN_SILICON.get(),
