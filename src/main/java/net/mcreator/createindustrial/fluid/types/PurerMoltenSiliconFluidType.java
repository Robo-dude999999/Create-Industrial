...
@EventBusSubscriber
public class PurerMoltenSiliconFluidType extends FluidType {
	public PurerMoltenSiliconFluidType() {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		...
		}, CreateIndustrialModFluidTypes.PURER_MOLTEN_SILICON_TYPE.get());
	}
}